...
Translate compact artifacts between Solana memo envelopes and EVM calldata records.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. SOL EVM Bytebridge explores a focused consumer use of that space while making the wire budget visible.
